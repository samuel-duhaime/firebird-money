...
category-group-not-found = No category group with id { $n }
category-group-duplicate-name = A category group with this name already exists
...
household-in-use = Household { $n } still has data connected to it (members, category groups, categories, or transactions)
...
auth-no-household = You must belong to a household
